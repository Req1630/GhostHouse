#ifndef SWTICH_DOOR_H
#define SWTICH_DOOR_H

#include "..\..\..\ObjectBase\GimmickBase\GimmickBase.h"

class CSwitchDoor : public CGimmickBase
{
	const char*	MAIN_MODEL_NAME = "SwitchDoor";	// 仕様モデル名.
	const float MODEL_SCALE = 0.08f;
public:
	CSwitchDoor( const stObjectInfo& objInfo  );
	~CSwitchDoor();
